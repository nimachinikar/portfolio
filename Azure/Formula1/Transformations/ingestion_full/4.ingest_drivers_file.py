...
spark.read.json(f'{raw_folder_path}/drivers.json').printSchema()
...
display(spark.read.schema(df_schema).json(f'{raw_folder_path}/drivers.json'))
...
df_drivers=spark.read.schema(df_schema).json('/mnt/formula1dl2323/raw/drivers.json')
