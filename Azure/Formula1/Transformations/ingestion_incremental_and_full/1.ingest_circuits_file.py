...
#read csv
df_circuits = spark.read.csv(f'{raw_folder_path}/{v_file_date}/circuits.csv',header=True,schema=df_schema)
...
#display(spark.read.delta(f'{processed_path_folder}/circuits'))
